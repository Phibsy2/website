...
import { Calendar, Dog, Clock, Plus, ArrowRight, Users, Percent } from 'lucide-react'
            ...
            <CardContent className="pt-6">
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-500">Einzelspaziergang</p>
                </div>
              </div>
            </CardContent>
          </Card>
        </Link>
        <Link href="/customer/group-booking">
          <Card className="hover:border-green-200 hover:shadow-md transition-all cursor-pointer relative overflow-hidden">
            ...
            <CardContent className="pt-6">
              <div className="flex items-center gap-4">
                ...
                <div>
                  <p className="font-semibold">Gruppenspaziergang</p>
                  <p className="text-sm text-gray-500">Mit Rabatt buchen</p>
                </div>
              </div>
            </CardContent>
          </Card>
        ...
        <Card>
          <CardContent className="pt-6">
            <div className="flex items-center gap-4">
              ...
              <div>
                <p className="font-semibold">{customer.dogs.filter(d => d.isGroupApproved).length}</p>
                <p className="text-sm text-gray-500">Gruppentauglich</p>
              </div>
            </div>
          </CardContent>
        </Card>
